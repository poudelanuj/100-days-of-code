...
public class mapActivity extends FragmentActivity implements OnMapReadyCallback ,GoogleApiClient.ConnectionCallbacks,GoogleApiClient.OnConnectionFailedListener,LocationListener{
       ...
       // floatingActionButton=(FloatingActionButton)findViewById(R.id.upload);
        ...
        /*floatingActionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dialog.setTitle("Upload Location");
                TextView text = (TextView) dialog.findViewById(R.id.text);
                text.setText("Do you want to upload current location?");
    ...
    public void onLocationChanged(Location location) {
        ...
        if(mCurrLocationMaker!=null){
            mCurrLocationMaker.remove();
        }
        //place current location maker
        LatLng latLng=new LatLng(location.getLatitude(),location.getLongitude());
        MarkerOptions markerOptions=new MarkerOptions();
        markerOptions.position(latLng);
        markerOptions.title("Currentt Position");
        markerOptions.icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_AZURE));
        mCurrLocationMaker=mMap.addMarker(markerOptions);
